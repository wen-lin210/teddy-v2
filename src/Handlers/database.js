...
async function initDatabase() {
    ...
    const dataPath = resolve(process.cwd(), "src", "Core", "data");
...
function updateJSON() {
    ...
    saveFile(
        resolve(process.cwd(), "src", "Core", "data", "threads.bak.json"),
        JSON.stringify(mapToObj(threads))
    );
    saveFile(
        resolve(process.cwd(), "src", "Core", "data", "threads.json"),
    ...
    saveFile(
        resolve(process.cwd(), "src", "Core", "data", "users.bak.json"),
        JSON.stringify(mapToObj(users))
    );
    saveFile(
        resolve(process.cwd(), "src", "Core", "data", "users.json"),
        formatData(mapToObj(users))
    );
    unlinkSync(resolve(process.cwd(), "src", "Core", "data", "users.bak.json"));
}
